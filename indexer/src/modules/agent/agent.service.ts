...
export class AgentService implements OnModuleInit {
  ...
  dbEncryptionKey = this.getEncryptionKeyFromHex(process.env.AGENT_ENCRYPTION_KEY);
  ...
  async onModuleInit() {
    // console.log('AgentService onModuleInit');
    // const keys = this.keyGenService.generateKeys();
    // console.log({keys});
